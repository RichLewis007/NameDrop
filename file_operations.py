...
class FileOperations:
    ...
    def is_valid_filename(self, filename: str) -> bool:
        ...
        invalid_chars = self.WINDOWS_INVALID_CHARS | self.MACOS_INVALID_CHARS | self.LINUX_INVALID_CHARS | self.CONTROL_CHARS
    ...
    def safe_rename_with_retry(self, old_path: Path, new_path: Path, max_retries: int = 3) -> bool:
        """
